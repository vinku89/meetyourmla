...
<div class="panel panel-default">
    <div class="panel-heading"><h2>Invest</h2></div>
	...
	<?php
                                                ...
                                                <?php }?>
      <form role="form" name="investmentForm" action="<?php echo base_url('home/investment');?>" method="post">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" rows="4" name="message" placeholder="Subject" required></textarea>
        </div>
        
        <button type="submit" class="btn btn-default" name="investmentPost" value="Submit">Submit</button>
      </form>
    </div>
  </div>
</div>
